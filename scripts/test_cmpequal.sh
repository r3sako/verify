...
MODEL_DIR="models/cmpequal"
RESULTS_DIR="results/cmpequal"
MODEL_FILE="$MODEL_DIR/cmpequal.smt2"
TIMEOUT=30000

mkdir -p "$RESULTS_DIR"
rm -f "$RESULTS_DIR"/*.txt  # Очистка

echo "Анализ модели CMPEQUAL: $MODEL_FILE" > "$RESULTS_DIR/results.txt"
